...
Plugin URI: https://www.webniraj.com/wordpress/
				...
				function widget_psnstatus($args) {
						...
						<?php
							...
							echo '<div class="psn-status-wrapper">'
								. file_get_contents( "https://psnstatus.xtremeps3.com/index.php?region=" . $options['region'] )
								. '</div>';
							//	please do not remove!
							echo '<div class="psn-status-powered-by">Powered by <a href="https://www.xtremeps3.com/?ref=psn-status-plugin" target="_blank">XTREME PS3</a></div>';
							echo $after_widget;
						?>
				<?php
				}
